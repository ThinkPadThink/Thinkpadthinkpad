...
Также, вся P-серия нумеруется одной буквой и двумя цифрами, как старые модели (например, P50).
...
P серия:
- P50 - настоящая йоба. 4/8 Skylake i7-HQ/Xeon, NVIDIA Quadro, 4 слота под ОЗУ (до 64ГБ ОЗУ), 3 слота под накопитель (можно воткнуть 2 x M2 2280 SATA/NVME+ 1 x SATA 2.5" или 2 x SATA 2.5"), ExpressCard/34. Есть Thunderbolt 3 с 4-мя линиями, что позволяет подцепить внешнюю карту и можно играть в эти ваши игоры. Дисплей на выбор FHD или 4K, хотя поговаривают, что оба варианта - дикое УГ. Недостаток ровно один - весит эта хуйня под 3 кг. Зато уронив на ногу, сломаешь ногу, а не ноут. 
