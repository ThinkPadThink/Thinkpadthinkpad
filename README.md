...
- **ThinkPad X1 Carbon/X1 Tablet/X1 YOGA** -  _Самый легкий в мире 14-дюймовый ультрабук бизнес-класса_.  Новая линейка пошла с 2011 года. Особенно продвигаемая Леновой. Имеет карбоновый корпус и продолжительное время работы. 

- **X1 Tablet** - Серия вышедшая на замену X2x0 tablet серии, является планшетом. 

- **X1 YOGA** - тот же карбон но с поворотным экраном и сенсорным дисплеем.
...
| ------------ | -------------- | ----------- | ------------------ |
| [Intel HD](http://www.notebookcheck.net/Intel-Graphics-Media-Accelerator-HD.23065.0.html) | | | X201/X201s/X201i, T410/T410s |
...
W-Series: Имеет 4 слота ОЗУ, 1 sata+Ultrabay и 1 msata / 2MiniPCI-E. Один из Mini PCI-E предназначен только для Wi-Fi модуля. Всё версии имеют Дискретную графику от Nvidia. Процессор установлен в сокет. 
...
![Сравнение slim диска с классическим](https://github.com/pepe-i-shim/Thinkpadthinkpad/blob/master/files/hdd-7mm_9.5mm.jpg
...
![До и после стачивания](https://github.com/pepe-i-shim/Thinkpadthinkpad/blob/master/files/x220-hdd-mod1.png)

После проделанных махинаций стандартный HDD очень аккуратно и с тугим ходом затискивается в отделение для диска.

![Диск в слоте](https://github.com/pepe-i-shim/Thinkpadthinkpad/blob/master/files/x220-hdd-mod2.png)
...
![](https://github.com/pepe-i-shim/Thinkpadthinkpad/blob/master/files/battery.png)
...
![](https://github.com/pepe-i-shim/Thinkpadthinkpad/blob/master/files/battery_9cell.png)
...
![](https://github.com/pepe-i-shim/Thinkpadthinkpad/blob/master/files/battery_marking1.png)
