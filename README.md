...
`Intel Anti-Theft/Computrance` - эта функция способна удаленно заблокировать украденный ноут и работает так же как на яблочных телефонах ICloud/Find My Iphone. Статус проверяется в BIOS.
...
Относится ко всем: На Wifi модули стоит WhiteList.
